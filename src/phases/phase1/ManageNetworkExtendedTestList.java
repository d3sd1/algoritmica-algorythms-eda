...
public class ManageNetworkExtendedTestList {
    ...
    public void testunion() {
        ...
        assertEquals("Check union, null.", true, lEmpty.equals(objManage.union(null, null)));
        assertEquals("Check union, null.", true, input1.equals(objManage.union(input1, null)));
        assertEquals("Check union, null.", true, input2.equals(objManage.union(null, input2)));
        assertEquals("Check union, null.", false, input2.equals(objManage.union(input1, input2)));
    ...
    public void testgetCampusCity() {
        ...
        assertEquals("Check getStudentsByCity, list 5. opc=2", true, lEmpty.equals(objManage.getCampusCity(lEmpty, 5)));
        assertEquals("Check getStudentsByCity, list empty. opc=-1", true, lEmpty.equals(objManage.getCampusCity(lEmpty, -1)));
        assertEquals("Check getStudentsByCity, list null. opc=-1", true, lEmpty.equals(objManage.getCampusCity(null, -1)));
    ...
    public void testlocateByCity() {
        ...
        assertEquals("Check locateByCity, list null.", true, lEmpty.equals(objManage.locateByCity(null, CITY)));
        assertEquals("Check locateByCity, list null w/ empty string.", true, lEmpty.equals(objManage.locateByCity(null, "")));
        assertEquals("Check locateByCity,  empty string.", true, lEmpty.equals(objManage.locateByCity(lEmpty, "")));
    ...
    public void testgetStudentsByDateInterval() {
        ...
        assertEquals("Check getStudentsByDateInterval, nulls.", true, lEmpty.equals(objManage.getStudentsByDateInterval(null, null, null)));
        assertEquals("Check getStudentsByDateInterval, list empty, dates null.", true, lEmpty.equals(objManage.getStudentsByDateInterval(lEmpty, null, null)));
        assertEquals("Check getStudentsByDateInterval, list empty, date null.", true, lEmpty.equals(objManage.getStudentsByDateInterval(lEmpty, START, null)));
        assertEquals("Check getStudentsByDateInterval, list empty, date null.", true, lEmpty.equals(objManage.getStudentsByDateInterval(lEmpty, null, END)));
        assertEquals("Check getStudentsByDateInterval, list null, date fill.", true, lEmpty.equals(objManage.getStudentsByDateInterval(null, START, END)));
