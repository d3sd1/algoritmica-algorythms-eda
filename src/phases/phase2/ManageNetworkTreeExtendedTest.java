...
public class ManageNetworkTreeExtendedTest {
    ...
    public void testgetOrderedList() {
        ...
        assertEquals("Check getOrderedList with a null tree.", true, emptyList.equals(objManage.getOrderedList(null)));
    ...
    public void testdeleteByNumberOfBlocks() {
        ...
        objManage.deleteByNumberOfBlocks(tree_1, -1);
        objManage.deleteByNumberOfBlocks(tree_2, 0);
    ...
    public void testcopySocialNetwork() {
        ...
        objManage.copySocialNetwork(null, null);
        ...
        objManage.copySocialNetwork(null, input_list);
        objManage.copySocialNetwork(tree_2, null);
